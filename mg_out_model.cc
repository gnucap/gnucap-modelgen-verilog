...
#include "mg_out.h"
/*--------------------------------------------------------------------------*/
static void make_model_dispatcher(std::ostream& out, const Model& m)
{
  if (m.level() != "") {
...
/*--------------------------------------------------------------------------*/
static void make_sdp_constructor(std::ostream& out, const Model& m)
{
#if 0
  out <<
...
/*--------------------------------------------------------------------------*/
static void make_tdp_constructor(std::ostream& out, const Model& m)
{
...
/*--------------------------------------------------------------------------*/
static void make_model_default_constructor(std::ostream& out, const Model& m)
{
#if 0
...
/*--------------------------------------------------------------------------*/
static void make_model_copy_constructor(std::ostream& out, const Model& m)
{
#if 0
  out <<
...
/*--------------------------------------------------------------------------*/
static void make_model_dev_type(std::ostream& out, const Model& m)
{
...
/*--------------------------------------------------------------------------*/
static void make_model_set_dev_type(std::ostream& out, const Model& m)
{
  out <<
...
/*--------------------------------------------------------------------------*/
static void make_model_precalc(std::ostream& out, const Model& m)
{
#if 0
  out <<
...
/*--------------------------------------------------------------------------*/
static void make_model_new_sdp(std::ostream& out, const Model& m)
{
...
/*--------------------------------------------------------------------------*/
static void make_model_set_param_by_index(std::ostream& out, const Model& m)
{
  out << 
...
/*--------------------------------------------------------------------------*/
void make_model_param_is_printable(std::ostream& out, const Model& m)
{
  make_tag();
...
/*--------------------------------------------------------------------------*/
void make_model_param_name(std::ostream& out, const Model& m)
{
  make_tag();
...
/*--------------------------------------------------------------------------*/
void make_model_param_name_or_alias(std::ostream& out, const Model& m)
{
  make_tag();
...
/*--------------------------------------------------------------------------*/
void make_model_param_value(std::ostream& out, const Model& m)
{
  make_tag();
