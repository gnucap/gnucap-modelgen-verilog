...
/*--------------------------------------------------------------------------*/
inline void set_type(node_t& n, std::string const& t)
{
...
/*--------------------------------------------------------------------------*/
inline LOGICVAL to_logic_(LOGICVAL l) {return l;}
inline LOGICVAL to_logic_(int i)
{
  if(i==1) {
    return lvSTABLE1;
  }else if(i==0) {
...
/*--------------------------------------------------------------------------*/
LOGICVAL operator| (int const& a, LOGICVAL const& b)
{
  LOGICVAL c(va::to_logic_(a));
  c |= b;
  return c;
}
/*--------------------------------------------------------------------------*/
